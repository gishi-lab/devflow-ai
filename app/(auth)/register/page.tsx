    ...
    <div className="min-h-full flex bg-slate-950">
      ...
      <div className="hidden lg:flex lg:flex-1 flex-col justify-between p-12 bg-slate-900 border-r border-slate-800">
        ...
        <div className="space-y-6">
          {[
            { icon: "✓", text: "Manage your dev tasks with ease" },
            { icon: "✓", text: "Save notes and build your glossary" },
            { icon: "✓", text: "Organize useful links and resources" },
            { icon: "✓", text: "Chat with an AI that understands code" },
          ].map((item) => (
            <div key={item.text} className="flex items-center gap-3">
              <div className="w-5 h-5 rounded-full bg-indigo-600/20 border border-indigo-500/30 flex items-center justify-center text-indigo-400 text-xs font-bold flex-shrink-0">
                {item.icon}
              </div>
          ...
          <form className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-xl bg-slate-900 border border-slate-700 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-sm"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-semibold py-2.5 px-4 rounded-xl transition-colors text-sm shadow-lg shadow-indigo-500/25 mt-2"
            >
              Create account
            </button>
          </form>
